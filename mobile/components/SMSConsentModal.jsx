...
const SMSConsentModal = ({ visible, onConsent, onDeny }) => {
  ...
  console.log("SMSConsentModal: visible =", visible);
      ...
      >
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          <Text style={[styles.description, { color: colors.textSecondary }]}>
            To automatically track your ride earnings and expenses, Sidekick
            needs access to your SMS messages. This allows us to:
          </Text>
          ...
          <View style={styles.bulletPoints}>
            <View style={styles.bulletPoint}>
              ...
              >
                Read mobile money transaction messages (MTN Mobile Money,
                AirtelTigo Money, etc.)
              </Text>
            </View>
            <View style={styles.bulletPoint}>
              <Ionicons
              ...
              <Text
                style={[styles.bulletText, { color: colors.textSecondary }]}
              >
                Automatically record payments received from Bolt, Yango, and
                other platforms
              </Text>
            </View>
            <View style={styles.bulletPoint}>
